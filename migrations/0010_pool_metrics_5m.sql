-- The base of the rollup layer (plans/03 §4). Two halves per bucket: flow
...
-- fabricated zero is not (plans/11 §3).
...
-- Modest volume (~30k rows/day across all pools, plans/11 §7) and indefinite
